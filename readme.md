# Spring PetClinic Sample Application[![Java CI with Maven](https://github.com/dstacho/spring-petclinic/actions/workflows/maven.yml/badge.svg)](https://github.com/dstacho/spring-petclinic/actions/workflows/maven.yml)
